...
module TrySampleCpuWlS (trySingleCycleCctWl, trySingleCycleRrfWl) where
...
import ControlMp
import Alu
import SingleCycleWlS
import SampleInstructions

((cl, pc, rim, rrf, alu, rdm), cct) = makeCircuit sampleCpuWl
...
trySingleCycleCctWl = cct5

trySingleCycleRrfWl = rrf
